...
import { ArrowRight, Award, Heart, Sparkles, Shield } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-5/12">
              <div className="relative">
                <div className="absolute -bottom-6 -right-6 w-full h-full bg-highlight/50 rounded-2xl" />
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-4 -left-4 bg-white shadow-lg rounded-xl px-5 py-3">
                  <p className="font-heading text-2xl font-bold text-primary">5.0 ★</p>
                  <p className="text-accent/50 text-xs">Google Reviews</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-7/12">
              ...
              <h2 className="font-heading text-3xl sm:text-4xl font-bold text-accent mt-3 leading-tight">
                Passion for Helping You
                <br />
                <span className="text-primary">Feel Your Best</span>
              </h2>

              <div className="mt-8 space-y-5 text-accent/70 leading-relaxed">
                <p>
                  ...
                  training at the prestigious <strong className="text-accent">Paul Mitchell</strong> school 
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <span className="bg-secondary text-accent/70 px-4 py-2 rounded-full text-sm font-medium">
