        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info) => (
              <div
                key={info.title}
                className="bg-white rounded-2xl p-8 text-center hover:shadow-lg transition-shadow duration-300 border border-beige/30"
              >
                <div className="w-14 h-14 bg-gold/10 rounded-xl flex items-center justify-center text-gold mx-auto mb-5">
                  {info.icon}
                </div>
                <h3 className="font-heading text-xl text-brown-dark mb-3">
                  {info.title}
                </h3>
                <div className="space-y-1 mb-5">
                  {info.details.map((detail, i) => (
                    <p key={i} className="text-brown-dark/55 text-sm">
                      {detail}
                    </p>
                  ))}
                </div>
                {info.action.href.startsWith("/") ? (
                  <Link
                    ...
                    className="inline-flex items-center gap-1 text-gold font-semibold text-sm hover:gap-2 transition-all duration-200"
                  >
                    {info.action.label}
                    <ArrowRight size={14} />
                  </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-2/3">
              <div className="bg-beige/30 rounded-2xl overflow-hidden aspect-video lg:aspect-auto lg:h-full min-h-[400px] flex items-center justify-center">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3185.7!2d-93.29!3n36.99!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzYuOTkwMCwtOTMuMjkwMA!5e0!3m2!1sen!2sus!4v1"
                  width="100%"
                  height="100%"
            ...
            <div className="w-full lg:w-1/3 space-y-8">
              <div>
                <h3 className="font-heading text-2xl text-brown-dark mb-4">
                  Finding Us
                </h3>
                <p className="text-brown-dark/55 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Navigation size={18} className="text-gold shrink-0 mt-1" />
                  <div>
                    <p className="font-semibold text-brown-dark text-sm">From Springfield</p>
                    <p className="text-brown-dark/50 text-sm">
                ...
                <div className="flex items-start gap-3">
                  <Car size={18} className="text-gold shrink-0 mt-1" />
                  <div>
                    <p className="font-semibold text-brown-dark text-sm">Parking</p>
                    <p className="text-brown-dark/50 text-sm">
              ...
              {/* Social */}
              <div>
                <h4 className="font-semibold text-brown-dark mb-3">Follow Us</h4>
                <div className="flex gap-3">
                  <a
                    href="https://instagram.com/esthetics.byerika"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-cream px-4 py-2.5 rounded-full text-sm font-medium text-brown-dark/70 hover:text-gold hover:shadow-md transition-all duration-200 border border-beige/30"
                  >
                    <Instagram size={18} />
                    Instagram
                  </a>
